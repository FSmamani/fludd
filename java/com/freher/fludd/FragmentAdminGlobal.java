...
public class FragmentAdminGlobal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_admin_global,container,false);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("foto");
